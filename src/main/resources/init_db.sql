...
CREATE TABLE `buckets` (
  ...
  `bucket_items_id` int DEFAULT NULL,
  `user_id` int NOT NULL,
  PRIMARY KEY (`bucket_id`),
  KEY `bucket_user_id_fk_to_users_idx` (`user_id`),
  CONSTRAINT `bucket_user_id_fk_to_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
